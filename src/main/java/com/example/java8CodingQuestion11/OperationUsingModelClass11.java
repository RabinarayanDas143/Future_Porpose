...
public class OperationUsingModelClass11 {
	public static void main(String[] args) {
		...
		List<String> map4 = empList.stream().map(e -> e.getName()).collect(Collectors.toList());
		...
		ModelClass map6 = empList.stream().sorted((a, b) -> b.getAge() - a.getAge()).findFirst()
		...
		ModelClass map9 = empList.stream().sorted((a, b) -> b.getYearOfJoining() - a.getYearOfJoining()).findFirst()
				.orElseThrow(() -> new RuntimeException("Exception Occoured.."));
		...
		// System.out.println("map11_grater30 :" + map11_grater30);
		// System.out.println("map12_less30 :" + map12_less30);
		...
		List<ModelClass> map14 = empList.stream().filter(e -> e.getDeptName().equalsIgnoreCase("HR"))
		...
		ModelClass map22 = empList.stream().sorted((a, b) -> a.getYearOfJoining() - b.getYearOfJoining()).findFirst()
				.get();
		// System.out.println(map22);

		// Print average and total salary of the organization.
		double map23_total = empList.stream().collect(Collectors.summingLong(e -> e.getSalary()));
		// System.out.println(map23_total);

		double map24_average = empList.stream().collect(Collectors.averagingDouble(e -> e.getSalary()));
		// System.out.println(map24_average);
		...
		Long map27_highestSalary = empList.stream().map(e -> e.getSalary()).sorted((a, b) -> b.compareTo(a)).findFirst()
				.get();
		// System.out.println(map27_highestSalary);

		// Find Second Highest salary in the organisation
		ModelClass map28 = empList.stream().sorted((a, b) -> ((Long) b.getSalary()).compareTo(a.getSalary())).skip(1)
				.findFirst().get();
		// System.out.println(map28);

		// Nth Highest salary
		int Nth = 3;
		ModelClass map29 = empList.stream().sorted((a, b) -> ((Long) b.getSalary()).compareTo(a.getSalary()))
				.skip(Nth - 1).findFirst().get();
		// System.out.println(map29);

		// Find highest paid salary in the organisation based on gender
		Map<Object, Object> map30 = empList.stream()
		...
		List<Long> map32 = empList.stream().map(e -> e.getSalary()).sorted().collect(Collectors.toList());
		// System.out.println(map32);

		// sort the employees salary in the organisation in descending order
		List<Long> map33 = empList.stream().map(e -> e.getSalary()).sorted((a, b) -> ((Long) b).compareTo(a))
				.collect(Collectors.toList());
		// System.out.println(map33);

		// Highest salary based on department
		Map<Object, Object> map34 = empList.stream()
		...
		// sort the employees salary in each department in ascending ordere
		Map<String, List<ModelClass>> map36 = empList.stream()
				.collect(Collectors.groupingBy(e -> e.getDeptName(),
						Collectors.collectingAndThen(Collectors.toList(),
								e -> e.stream().sorted((a, b) -> ((Long) a.getSalary()).compareTo(b.getSalary()))
										.collect(Collectors.toList()))));
		System.out.println(map36);
		// map36.forEach((a, b) -> System.out.println(a + " :" + b));
		for (Map.Entry<String, List<ModelClass>> entry : map36.entrySet()) {
